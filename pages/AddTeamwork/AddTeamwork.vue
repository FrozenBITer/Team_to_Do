<template>
  <view class="flex-col page">
    ...
    <view class="flex-col group mt-28">
      ...
      <view class="flex-col self-stretch group_11 view_2">
      ...
      <view class="flex-col self-stretch group_11 view_3">
        <text class="self-start font_5 text_13">任务类型</text>
        <view class="flex-row self-stretch mt-17">
          <view class="flex-col justify-start items-center text-wrapper_2" @click="onClick_2">
            <text class="font text_14">个人</text>
          </view>
      ...
      <view class="flex-col self-stretch group_11 view_4">
        ...
        <view class="flex-col justify-start items-center text-wrapper_4 mt-15" @click="onClick_3">
          <text class="font_6 text_23">确认添加</text>
        </view>
      </view>
    </view>
  </view>
...
<script>
  export default {
    ...
    methods: {
      ...
      onClick_2() {
        uni.navigateTo({ url: '/pages/AddSolowork/AddSolowork' });
      },
      onClick_3() {
